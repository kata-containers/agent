...
// GetEvents() with a EventsRequest pid field set to a
...
type EventsRequest struct {
	ContainerId string                      `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	PID         uint32                      `protobuf:"varint,2,opt,name=PID,proto3" json:"PID,omitempty"`
	Timestamp   *google_protobuf3.Timestamp `protobuf:"bytes,3,opt,name=timestamp" json:"timestamp,omitempty"`
}

func (m *EventsRequest) Reset()                    { *m = EventsRequest{} }
func (m *EventsRequest) String() string            { return proto.CompactTextString(m) }
func (*EventsRequest) ProtoMessage()               {}
func (*EventsRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{22} }

func (m *EventsRequest) GetContainerId() string {
	if m != nil {
		return m.ContainerId
	}
	return ""
...
func (m *EventsRequest) GetPID() uint32 {
	if m != nil {
		return m.PID
	}
	return 0
...
func (m *EventsRequest) GetTimestamp() *google_protobuf3.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (*ContainerTermination) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{23} }

func (m *ContainerTermination) GetContainerId() string {
	if m != nil {
		return m.ContainerId
	}
	return ""
...
func (m *ContainerTermination) GetExitCode() int32 {
	if m != nil {
		return m.ExitCode
	}
	return 0
...
func (*ProcessTermination) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{24} }

func (m *ProcessTermination) GetProcessId() string {
	if m != nil {
		return m.ProcessId
	}
	return ""
...
func (m *ProcessTermination) GetExitCode() int32 {
	if m != nil {
		return m.ExitCode
	}
	return 0
...
func (*Event) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{25} }
...
type AgentServiceClient interface {
	...
	// events
	GetEvents(ctx context.Context, in *EventsRequest, opts ...grpc1.CallOption) (AgentService_GetEventsClient, error)
}
...
func (c *agentServiceClient) GetEvents(ctx context.Context, in *EventsRequest, opts ...grpc1.CallOption) (AgentService_GetEventsClient, error) {
	stream, err := grpc1.NewClientStream(ctx, &_AgentService_serviceDesc.Streams[0], c.cc, "/grpc.AgentService/GetEvents", opts...)
	if err != nil {
		return nil, err
	}
	x := &agentServiceGetEventsClient{stream}
...
type AgentService_GetEventsClient interface {
	Recv() (*Event, error)
	grpc1.ClientStream
}

type agentServiceGetEventsClient struct {
	grpc1.ClientStream
}

func (x *agentServiceGetEventsClient) Recv() (*Event, error) {
	m := new(Event)
...
type AgentServiceServer interface {
	...
	// events
	GetEvents(*EventsRequest, AgentService_GetEventsServer) error
}
...
func _AgentService_GetEvents_Handler(srv interface{}, stream grpc1.ServerStream) error {
	m := new(EventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AgentServiceServer).GetEvents(m, &agentServiceGetEventsServer{stream})
}

type AgentService_GetEventsServer interface {
	Send(*Event) error
	grpc1.ServerStream
}

type agentServiceGetEventsServer struct {
	grpc1.ServerStream
}

func (x *agentServiceGetEventsServer) Send(m *Event) error {
	...
	Streams: []grpc1.StreamDesc{
		{
			...
			Handler:       _AgentService_GetEvents_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptorAgent = []byte{
	...
	,
}

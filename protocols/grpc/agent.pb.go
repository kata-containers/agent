...
type CreateContainerRequest struct {
	...
	OCI         *Spec       `protobuf:"bytes,4,opt,name=OCI,json=oCI" json:"OCI,omitempty"`
}
...
type NewProcessResponse struct {
	PID uint32 `protobuf:"varint,1,opt,name=PID,json=pID,proto3" json:"PID,omitempty"`
}
...
type SignalProcessRequest struct {
	ContainerId string `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	PID         uint32 `protobuf:"varint,2,opt,name=PID,json=pID,proto3" json:"PID,omitempty"`
...
func (*ListInterfaceRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{22} }
...
func (*ListInterfaceResponse) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{23} }
...
func (*RouteRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{24} }
...
func (*ListRouteRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{25} }
...
func (*ListRouteResponse) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{26} }

func (m *ListRouteResponse) GetRoute() []*Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func (*OnlineCPUMemRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{27} }
...
func (*Storage) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{28} }
...
func init() {
	...
	proto.RegisterType((*ListInterfaceRequest)(nil), "grpc.ListInterfaceRequest")
	proto.RegisterType((*ListInterfaceResponse)(nil), "grpc.ListInterfaceResponse")
	proto.RegisterType((*RouteRequest)(nil), "grpc.RouteRequest")
	proto.RegisterType((*ListRouteRequest)(nil), "grpc.ListRouteRequest")
	proto.RegisterType((*ListRouteResponse)(nil), "grpc.ListRouteResponse")
...
type AgentServiceClient interface {
	...
	ListInterface(ctx context.Context, in *ListInterfaceRequest, opts ...grpc1.CallOption) (*ListInterfaceResponse, error)
	...
	ListRoute(ctx context.Context, in *ListRouteRequest, opts ...grpc1.CallOption) (*ListRouteResponse, error)
...
func (c *agentServiceClient) ListInterface(ctx context.Context, in *ListInterfaceRequest, opts ...grpc1.CallOption) (*ListInterfaceResponse, error) {
	out := new(ListInterfaceResponse)
	err := grpc1.Invoke(ctx, "/grpc.AgentService/ListInterface", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) ListRoute(ctx context.Context, in *ListRouteRequest, opts ...grpc1.CallOption) (*ListRouteResponse, error) {
	out := new(ListRouteResponse)
	err := grpc1.Invoke(ctx, "/grpc.AgentService/ListRoute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_ListInterface_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListInterfaceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).ListInterface(ctx, in)
	}
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AgentService/ListInterface",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ListInterface(ctx, req.(*ListInterfaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AgentService_ListRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).ListRoute(ctx, in)
	}
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AgentService/ListRoute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ListRoute(ctx, req.(*ListRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AgentService_serviceDesc = grpc1.ServiceDesc{
	...
	Methods: []grpc1.MethodDesc{
		...
		},
		{
			...
			Handler:    _AgentService_ListInterface_Handler,
		},
		{
			MethodName: "AddRoute",
		...
		},
		{
			...
			Handler:    _AgentService_ListRoute_Handler,
		},
		{
...
var fileDescriptorAgent = []byte{
	...
	,
}
